...
import com.source.excEnv.state.LoadState;
import com.source.excEnv.state.State;
import com.source.framework.util.InputHandler;
...
public class Game extends JPanel implements Runnable {
	...
	public void run() {
		...
		while(running) {
			...
			sleepDurationMillis = Math.max(6, updateDurationMillis);	//calc sleepDurationMillis
